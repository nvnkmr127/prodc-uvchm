    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('payments')) {
            Schema::table('payments', function (Blueprint $table) {
                ...
                try {
                    $table->dropIndex('idx_payments_student_date');
                } catch (\Exception $e) {
                }
            });
        }
        ...
        if (Schema::hasTable('students')) {
            Schema::table('students', function (Blueprint $table) {
                ...
                try {
                    $table->dropIndex('idx_students_batch_id');
                } catch (\Exception $e) {
                }
                try {
                    $table->dropIndex('idx_students_enrollment');
                } catch (\Exception $e) {
                }
                try {
                    $table->dropIndex('idx_students_batch_status');
                } catch (\Exception $e) {
                }
            });
        }
        ...
        if (Schema::hasTable('student_fees')) {
            Schema::table('student_fees', function (Blueprint $table) {
                ...
                try {
                    $table->dropIndex('idx_student_fees_category');
                } catch (\Exception $e) {
                }
                try {
                    $table->dropIndex('idx_student_fees_due_date');
                } catch (\Exception $e) {
                }
            });
        }
