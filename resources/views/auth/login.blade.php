...
<head>
    ...
    <title>Login - {{ $settings['college_name']->value ?? config('app.name', 'Laravel') }}</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        {{-- This section now displays the logo --}}
                                        @if(isset($settings['college_logo']))
                                            <img src="{{ asset('storage/' . $settings['college_logo']->value) }}" alt="College Logo" style="max-height: 80px;" class="mb-4">
                                        @endif
