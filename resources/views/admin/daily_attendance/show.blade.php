...
@section('title', 'Daily Attendance - ' . date('F j, Y', strtotime($date)))
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            ...
            Daily Attendance - {{ date('F j, Y', strtotime($date)) }}
        </h1>
        <div class="d-sm-flex">
            <a href="{{ route('admin.daily-attendance.index') }}" class="btn btn-secondary btn-sm mr-2">
                <i class="fas fa-arrow-left"></i> Back to List
            </a>
            <a href="{{ route('admin.daily-attendance.create', ['date' => $date]) }}" class="btn btn-primary btn-sm">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.daily-attendance.show') }}">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="{{ route('admin.daily-attendance.show') }}" class="btn btn-secondary">
        ...
        <div class="card-body">
                        ...
                        <tbody>
                            @foreach($attendances as $attendance)
                                <tr>
                                        ...
                                        @if($attendance->student)
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="small text-gray-600">{{ $attendance->student->enrollment_number }}</div>
                                                </div>
                                            </div>
                                        @else
                                    ...
                                    <td>
                                        @can('edit attendance')
                                            <a href="{{ route('admin.daily-attendance.edit', $attendance->id) }}" 
            ...
            @else
                <div class="text-center py-4">
                    ...
                    <p class="text-gray-400">No attendance has been marked for the selected date and filters.</p>
