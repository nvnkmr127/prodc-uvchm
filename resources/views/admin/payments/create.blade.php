...
<style>
    ...
    .stats-card.danger { border-left-color: #fa709a; }
    .stats-card.warning { border-left-color: #fcb69f; }
    .stats-card.info { border-left-color: #a8edea; }
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 opacity-90">Process payment for {{ $student->name }} ({{ $student->enrollment_number }})</p>
                </div>
            ...
            <div class="modern-card">
                <div class="modern-card-header">
                    <div class="d-flex align-items-center">
                        <div class="icon-wrapper bg-primary me-3" style="width: 40px; height: 40px; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                    ...
                    <form action="{{ route('admin.component-payments.store') }}" method="POST" id="paymentForm">
                        ...
                        <div class="mb-4">
                            ...
                            @if(isset($unpaidFees) && $unpaidFees->count() > 0)
                                @foreach($unpaidFees->groupBy('fee_category_id') as $categoryId => $fees)
                                    @php
                                        ...
                                        if (!$category || !$category->name) continue; // Skip if category is null or has no name
                                        ...
                                        if ($totalRemaining <= 0) continue; // Skip if nothing remaining to pay
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="form-check me-3 mt-1">
                                            <input type="checkbox" class="form-check-input component-checkbox" 
                                                   ...
                                                   name="components[{{ $categoryId }}][selected]" 
                                                   value="1">
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div>
                                                    <label class="form-check-label fw-bold" for="component_{{ $categoryId }}">
                                                        {{ $category->name }}
                                                    </label>
                                                    @if($hasOverdue)
                                                ...
                                                <div class="text-end">
                                                    <div class="fw-bold text-primary">₹{{ number_format($totalRemaining, 2) }}</div>
                                            ...
                                            <div class="component-details" style="display: none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="hidden" name="components[{{ $categoryId }}][fee_category_id]" value="{{ $categoryId }}">
                                                        <div class="input-group">
                                                            <span class="input-group-text">₹</span>
                                                            <input type="number" class="form-control modern-input amount-input" 
                                                                   name="components[{{ $categoryId }}][amount]" 
                                                                   min="0.01" max="{{ $totalRemaining }}" step="0.01"
                                                                   placeholder="0.00">
                                                        </div>
                                                        <small class="text-muted">Maximum: ₹{{ number_format($totalRemaining, 2) }}</small>
                                                        
                                                        <div class="mt-2">
                                                            <button type="button" class="btn btn-sm btn-outline-primary pay-full-btn" 
                                                                ...
                                                                <div class="fee-breakdown-item">
                                                                    <div class="flex-grow-1">
                                                                        ...
                                                                        <div class="small text-muted">
                                                                            Due: {{ $fee->due_date ? $fee->due_date->format('d M Y') : 'N/A' }}
                                                                        </div>
                                                                    </div>
                                                                    <div class="text-end">
                                                                        <div class="small fw-bold">₹{{ number_format($remaining, 2) }}</div>
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <a href="{{ route('admin.students.show', $student) }}" class="btn btn-gradient btn-gradient-primary">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="transaction_id" class="form-label fw-bold">Transaction Reference</label>
