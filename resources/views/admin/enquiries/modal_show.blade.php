<style>
    ...
    .quick-sched-btn:hover,
    .quick-sched-btn.active {
        background: #4e73df;
        color: white;
        border-color: #4e73df;
    }
        ...
        <div class="col-md-5 border-right">
            ...
            <div class="text-center mb-3">
                ...
                <div class="d-flex justify-content-center gap-2 mt-2">
                    ...
                    <a href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', $enquiry->phone_number) }}"
                        target="_blank" class="btn btn-warning btn-sm btn-circle" title="WhatsApp">
            ...
            <form action="{{ route('admin.enquiries.update', $enquiry->id) }}" method="POST" id="modalEditForm">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="student_name" class="form-control form-control-sm-custom"
                        value="{{ $enquiry->student_name }}" required>
                </div>
                ...
                <div class="row">
                    <div class="col-6 pr-1">
                        <div class="form-group mb-2">
                            ...
                            <input type="tel" name="phone_number" class="form-control form-control-sm-custom"
                                value="{{ $enquiry->phone_number }}" required>
                        </div>
                    </div>
                ...
                <div class="form-group mb-2" id="modalReferralWrapper" style="display: none;">
                    ...
                    <input type="text" name="referral_name" id="modalReferralInput"
                        class="form-control form-control-sm-custom" value="{{ $enquiry->referral_name }}">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="address" class="form-control form-control-sm-custom"
                        rows="2">{{ $enquiry->address }}</textarea>
                </div>
                ...
                @if($enquiry->status !== 'Admitted')
                    <a href="{{ route('admin.enquiries.convertToAdmission', $enquiry->id) }}"
                        class="btn btn-outline-success btn-sm btn-block mt-2">
        ...
        <div class="col-md-7">
            ...
            <div class="bg-light p-3 rounded mb-3 border">
                ...
                <form action="{{ route('admin.enquiries.follow-ups.store', $enquiry->id) }}" method="POST"
                    id="ajaxFollowUpForm">
                    @csrf
                    <textarea name="notes" id="followUpNotes" class="form-control form-control-sm mb-2" rows="2"
                        placeholder="Enter call notes, discussion points..." required></textarea>
                                                ...
                                                @foreach($item->properties['attributes'] as $key => $newValue)
                                                    @php
                                                        ...
                                                        if ($key == 'status') {
                                                            ...
                                                            $label = "Counselor";
                                                            $oldValue = $usersLookup[$oldValue] ?? 'Unassigned';
                                                            $newValue = $usersLookup[$newValue] ?? 'Unassigned';
                                                        }
                                                    @endphp
                                                    <li>
                                                        <strong>{{ $label }}:</strong>
