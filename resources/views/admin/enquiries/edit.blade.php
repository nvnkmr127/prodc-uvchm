                    ...
                    <div class="card-body pt-5 pb-4">
                        <div class="text-center">
                            ...
                            <div class="d-flex justify-content-center gap-2 mb-4">
                                ...
                                <a href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', $enquiry->phone_number) }}"
                                    target="_blank" class="btn btn-outline-success btn-sm mx-1">
                        ...
                        <form action="{{ route('admin.enquiries.update', $enquiry->id) }}" method="POST" id="profileForm">
                                    ...
                                    <div class="form-label-group">
                                        ...
                                        <select name="gender" class="form-control">
                                            ...
                                            @foreach(['Male', 'Female', 'Other'] as $g)
                                                <option value="{{ $g }}" {{ $enquiry->gender == $g ? 'selected' : '' }}>{{ $g }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-label-group">
                                ...
                                <select name="status"
                                    class="form-control font-weight-bold text-{{ $enquiry->status == 'New' ? 'primary' : 'dark' }}">
                            ...
                            <div class="form-label-group">
                                ...
                                <select name="source" class="form-control" id="sourceSelect">
                                    ...
                                    @foreach($sources as $src)
                                        <option value="{{ $src }}" {{ $enquiry->source == $src ? 'selected' : '' }}>{{ $src }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>

                            <div class="form-label-group" id="referralWrapper"
                                style="{{ $enquiry->referral_name ? 'display:block;' : 'display:none;' }}">
                                <label id="referralLabel">Referral Name</label>
                                <input type="text" name="referral_name" id="referralInput" class="form-control"
                                    value="{{ $enquiry->referral_name }}">
                            </div>
                        ...
                        <form action="{{ route('admin.enquiries.follow-ups.store', $enquiry->id) }}" method="POST">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <textarea name="notes" class="form-control border-0 shadow-sm mb-3" rows="2"
                                        placeholder="What did you discuss? e.g. 'Called parent, asked to call back on Monday...'"
                                        required></textarea>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                        <div class="d-flex align-items-center mb-2 mb-md-0">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="quick-sched-btn" onclick="setDays(1)">+1
                                                    Day</button>
                                                <button type="button" class="quick-sched-btn" onclick="setDays(3)">+3
                                                    Days</button>
                                                <button type="button" class="quick-sched-btn" onclick="setDays(7)">+1
                                                    Week</button>
                                            </div>
                                        </div>
