...
@section('title', 'Faculty Attendance Data Report')
...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Faculty Attendance Analysis Report</h1>
            <div>
            ...
            <div class="card-body">
                <form id="attendance_report_filters" class="row align-items-end">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="department" class="form-control bg-light border-0 shadow-none select2"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="start_date" class="form-control bg-light border-0 shadow-none"
                            value="{{ $startDate ?? '' }}" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="small font-weight-bold text-gray-600">End Date</label>
                        <input type="date" name="end_date" class="form-control bg-light border-0 shadow-none"
        ...
        <div class="stats-grid" id="stats_container">
            ...
            <div class="stat-card-mini border-success">
                ...
                <div class="stat-value"><span
                        id="stat_avg_attendance">{{ isset($stats) ? $stats['avg_attendance'] : 0 }}</span><small>%</small>
                </div>
            ...
            <div class="stat-card-mini border-danger">
                ...
                <div class="stat-value text-danger" id="stat_avg_absent">{{ isset($stats) ? $stats['avg_absent'] : 0 }}
                </div>
            ...
            <div class="col-xl-6 col-lg-6 mb-4">
                <div class="card shadow border-0 rounded-lg h-100">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="m-0 font-weight-bold text-primary">Attendance Distribution (Faculty)</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="card shadow border-0 rounded-lg mb-4" id="table_card">
            ...
            <div class="card-body p-0" id="table_container">
                ...
                @if(isset($faculties) && count($faculties) > 0)
                    @include('admin.reports.faculty-attendance._table')
                @else
