...
.stat-icon.enrollment { background: var(--primary-color); }
.stat-icon.payments { background: var(--success-color); }
.stat-icon.attendance { background: var(--info-color); }
...
.activity-icon.payment { background: rgba(16, 185, 129, 0.1); color: var(--success-color); }
.activity-icon.login { background: rgba(79, 70, 229, 0.1); color: var(--primary-color); }
.activity-icon.update { background: rgba(245, 158, 11, 0.1); color: var(--warning-color); }
.activity-icon.delete { background: rgba(239, 68, 68, 0.1); color: var(--danger-color); }
...
.attendance-percentage.excellent { color: var(--success-color); }
.attendance-percentage.good { color: var(--info-color); }
.attendance-percentage.average { color: var(--warning-color); }
.attendance-percentage.poor { color: var(--danger-color); }
...
<div class="container-fluid">
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="mb-2">
                            <i class="fas fa-graduation-cap mr-3"></i> Welcome back, <strong>{{ $dashboard_data['user_name'] ?? auth()->user()->name }}</strong>
                        </h1>
                    ...
                    <div class="col-md-4 text-md-right">
                        <div class="dashboard-date">
                            ...
                            <div class="text-sm opacity-75" id="current-time">
                                ...
                                <span id="live-time">{{ $dashboard_data['current_time'] ?? now()->format('H:i:s') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="stats-overview">
        ...
        <div class="stat-card">
            ...
            <div class="stat-number" id="my-collections-today">₹{{ number_format($dashboard_data['my_collections']['today'] ?? 0) }}</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-trend {{ ($dashboard_data['attendance_trend'] ?? 0) >= 0 ? 'trend-positive' : 'trend-negative' }}">
                ...
                <div class="widget-body">
                    ...
                    <div class="attendance-overview">
                        <div class="attendance-stat">
                            <div class="attendance-percentage excellent">{{ $dashboard_data['attendance_stats']['excellent'] ?? 0 }}%</div>
                            <div class="attendance-label">Excellent (90%+)</div>
                        </div>
                        <div class="attendance-stat">
                            <div class="attendance-percentage good">{{ $dashboard_data['attendance_stats']['good'] ?? 0 }}%</div>
                            <div class="attendance-label">Good (75-89%)</div>
                        </div>
                        <div class="attendance-stat">
                            <div class="attendance-percentage average">{{ $dashboard_data['attendance_stats']['average'] ?? 0 }}%</div>
                            <div class="attendance-label">Average (60-74%)</div>
                        </div>
                        <div class="attendance-stat">
                            <div class="attendance-percentage poor">{{ $dashboard_data['attendance_stats']['poor'] ?? 0 }}%</div>
