                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($token->last_used_at)
                                                    ...
                                                    <small
                                                        class="text-muted d-block">{{ $token->last_used_at->diffForHumans() }}</small>
                                                @else
                                            ...
                                            <td>
                                                ...
                                                <small
                                                    class="text-muted d-block">{{ $token->created_at->diffForHumans() }}</small>
                                            </td>
                                            <td>
                                        ...
                                        <tbody>
                                            @foreach($recentActivity as $activity)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge badge-{{ $activity['status'] == 200 ? 'success' : 'danger' }}">
