...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Add New Expense Category</h1>
    ...
    <div class="card-body">
        <form action="{{ route('admin.expense-categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="e.g., Faculty Salaries, Utilities" required>
            </div>
