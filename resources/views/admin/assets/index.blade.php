...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <button class="btn btn-sm btn-danger shadow-sm" id="bulk-delete-btn" style="display: none;"><i
                    class="fas fa-trash fa-sm text-white-50"></i> Delete Selected</button>
            <button class="btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addAssetModal"><i
                    class="fas fa-plus fa-sm text-white-50"></i> Add New Asset</button>
                    ...
                    <form action="{{ route('admin.assets.import.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="alert alert-info">
                                ...
                                <p class="mt-2 mb-0">
                                    Required columns: <code>name</code>, <code>asset_category_id</code>,
                                    <code>purchase_date</code>, <code>cost</code>, <code>serial_number</code>
                                </p>
                            </div>
                    ...
                    <tbody>
                        @foreach ($assets as $asset)
                            <tr data-asset-id="{{ $asset->id }}">
                                ...
                                <td>
                                    <button class="btn btn-info btn-sm view-btn" title="Quick View"><i
                                            class="fas fa-eye"></i></button>
                                    <button class="btn btn-warning btn-sm edit-btn" title="Edit"><i
    ...
    <div class="modal fade" id="addAssetModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Asset</h5><button type="button" class="close"
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.assets.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-8 mb-3"><label>Asset Name*</label><input type="text" name="name"
                                    class="form-control" required></div>
                            <div class="col-md-4 mb-3"><label>Asset Code</label><input type="text" name="asset_code"
                                    class="form-control"></div>
                            <div class="col-md-6 mb-3"><label>Category*</label><select name="asset_category_id"
                                    class="form-control" required>
                                    <option value="">-- Select --</option>@foreach($categories as $cat)<option
                                    value="{{ $cat->id }}">{{ $cat->name }}</option>@endforeach
                                </select></div>
                            <div class="col-md-6 mb-3"><label>Location*</label><input type="text" name="location"
                                    class="form-control" required></div>
                            <div class="col-md-6 mb-3"><label>Condition*</label><select name="condition"
                                    class="form-control" required>
                                    <option>Good</option>
                                    <option>Fair</option>
                            ...
                            <div class="col-md-6 mb-3"><label>Quantity*</label><input type="number" name="quantity"
                                    class="form-control" value="1" required></div>
                            <div class="col-md-6 mb-3"><label>Purchase Date</label><input type="date" name="purchase_date"
                                    class="form-control"></div>
    ...
    <div class="modal fade" id="editAssetModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Asset</h5><button type="button" class="close"
                        data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <form id="editAssetForm" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3"><label>Asset Code</label><input type="text" name="asset_code"
                                    id="edit_asset_code" class="form-control"></div>
                            <div class="col-md-6 mb-3"><label>Category*</label><select name="asset_category_id"
                                    id="edit_asset_category_id" class="form-control" required>@foreach($categories as $cat)
                                    <option value="{{ $cat->id }}">{{ $cat->name }}</option>@endforeach</select></div>
                            <div class="col-md-6 mb-3"><label>Location*</label><input type="text" name="location"
                                    id="edit_location" class="form-control" required></div>
                            <div class="col-md-6 mb-3"><label>Condition*</label><select name="condition" id="edit_condition"
                                    class="form-control" required>
                                    <option>Good</option>
                                    <option>Fair</option>
                                    <option>Needs Repair</option>
                            ...
                            <div class="col-md-6 mb-3"><label>Quantity*</label><input type="number" name="quantity"
                                    id="edit_quantity" class="form-control" required></div>
                            <div class="col-md-6 mb-3"><label>Purchase Date</label><input type="date" name="purchase_date"
                                    id="edit_purchase_date" class="form-control"></div>
                            <div class="col-md-6 mb-3"><label>Purchase Price</label><input type="number" step="0.01"
                                    name="purchase_price" id="edit_purchase_price" class="form-control"></div>
                        </div>
    ...
    <div class="modal fade" id="viewAssetModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_name">Asset Details</h5><button type="button" class="close"
                        data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
