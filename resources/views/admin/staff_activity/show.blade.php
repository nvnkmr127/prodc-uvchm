...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-8">
            ...
            <!-- Timeline Feed -->
            <div class="card border-0 shadow-sm mt-4" style="border-radius: 1.5rem;">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    <h5 class="font-weight-bold text-gray-800">Operational Timeline</h5>
                    ...
                    <ul class="timeline-advanced">
                        ...
                        @empty
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">No historical data found for this range.</p>
                            </div>
                        @endforelse
                    </ul>
