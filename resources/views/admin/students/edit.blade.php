...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.students.show', $student) }}" class="btn btn-sm btn-light shadow-sm"><i
                class="fas fa-arrow-left fa-sm text-gray-600"></i> Back to Profile</a>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select name="source" id="source" class="form-control" required>
                                    ...
                                    <option value="Agent" {{ old('source', $student->source) == 'Agent' ? 'selected' : '' }}>
                                        Agent</option>
                                    <option value="Referrals" {{ old('source', $student->source) == 'Referrals' ? 'selected' : '' }}>Referrals</option>
                                    <option value="pro" {{ old('source', $student->source) == 'pro' ? 'selected' : '' }}>Pro
                                    </option>
                                    <option value="list" {{ old('source', $student->source) == 'list' ? 'selected' : '' }}>
                                        List</option>
                                    ...
                                    <option value="Other" {{ old('source', $student->source) == 'Other' ? 'selected' : '' }}>
                                        Other</option>
                                </select>
                            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-3">
                            <img src="{{ $student->photo ? asset('storage/' . $student->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($student->name) . '&size=128&background=4e73df&color=fff' }}"
                                class="img-thumbnail rounded-circle" alt="Student Photo" width="128" height="128">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="enrollment_number" name="enrollment_number" class="form-control"
