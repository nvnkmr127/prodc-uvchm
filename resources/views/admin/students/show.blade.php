...
@if(session('success'))
    <div class="alert alert-success alert-dismissible fade show" style="position: fixed; top: 20px; right: 20px; z-index: 9999; min-width: 300px; border-radius: 10px;">
    ...
    <div class="card-body px-4 pb-4 pt-0">
        <div class="row">
            <div class="col-lg-auto text-center text-lg-left">
                <di<div class="student-avatar-container">
                    @php
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap">
                    <div class="mb-3">
                        <h2 class="font-weight-bold text-gray-800 mb-1">
                            {{ $student->name }}
                            <small class="text-muted h6 ml-2 font-weight-normal">({{ $student->enrollment_number }})</small>
                        </h2>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="meta-pill biometric-badge" title="Biometric Device ID">
                   ...
                   <div class="col-lg-6 text-lg-right d-flex align-items-end justify-content-lg-end">
                        <div class="action-bar">
                            {{-- Primary Action --}}
                            <button onclick="openPaymentModal()" class="btn btn-success shadow-sm font-weight-bold">
                                <i class="fas fa-credit-card mr-1"></i> Pay Fee
                            </button>

                            {{-- Secondary Actions (Visible) --}}
                            @if(Route::has('admin.payments.component-dashboard'))
                                <a href="{{ route('admin.payments.component-dashboard', $student) }}" class="btn btn-info shadow-sm">
                                    <i class="fas fa-file-invoice-dollar mr-1"></i> Ledger
                                </a>
                            @endif

                            <button class="btn btn-warning shadow-sm" data-toggle="modal" data-target="#applyConcessionModal">
                                <i class="fas fa-percent mr-1"></i> Concession
                            </button>

                            {{-- Tertiary Actions (Icons) --}}
                            <a href="{{ route('admin.students.edit', $student) }}" class="btn btn-light border" title="Edit Profile">
                                <i class="fas fa-pen text-gray-600"></i>
                            </a>

                            <button onclick="window.print()" class="btn btn-light border" title="Print Profile">
...
<div class="row mb-4">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h4 mb-0 font-weight-bold text-gray-800 amount-counter">₹{{ number_format(isset($financialSummary['total_amount']) ? $financialSummary['total_amount'] : 0, 0) }}</div>
                        <div class="text-xs text-muted">
                            {{ isset($financialSummary['payment_percentage']) ? $financialSummary['payment_percentage'] : 0 }}% completed
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h4 mb-0 font-weight-bold text-gray-800 amount-counter">₹{{ number_format(isset($financialSummary['paid_amount']) ? $financialSummary['paid_amount'] : 0, 0) }}</div>
                        @if(isset($financialSummary['concession_amount']) && $financialSummary['concession_amount'] > 0)
                            <div class="text-xs text-success">
                                <i class="fas fa-percent mr-1"></i>₹{{ number_format($financialSummary['concession_amount'], 0) }} concession
                            </div>
                        @endif
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-{{ isset($financialSummary['remaining_amount']) && $financialSummary['remaining_amount'] > 0 ? 'danger' : 'success' }} shadow h-100 stat-card">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-{{ isset($financialSummary['remaining_amount']) && $financialSummary['remaining_amount'] > 0 ? 'danger' : 'success' }} text-uppercase mb-1">
                            Outstanding Due
                        </div>
                        <div class="h4 mb-0 font-weight-bold text-gray-800 amount-counter">₹{{ number_format(isset($financialSummary['remaining_amount']) ? $financialSummary['remaining_amount'] : 0, 0) }}</div>
                    ...
                    <div class="col-auto">
                        <i class="fas fa-{{ isset($financialSummary['remaining_amount']) && $financialSummary['remaining_amount'] > 0 ? 'exclamation-triangle' : 'check-circle' }} fa-3x text-{{ isset($financialSummary['remaining_amount']) && $financialSummary['remaining_amount'] > 0 ? 'danger' : 'success' }} opacity-50"></i>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <small class="text-muted">{{ isset($financialSummary['payment_percentage']) ? $financialSummary['payment_percentage'] : 0 }}% completed</small>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-4">
                                <div class="p-2 rounded bg-light">
                                    <div class="text-success font-weight-bold">₹{{ number_format(isset($financialSummary['paid_amount']) ? $financialSummary['paid_amount'] : 0, 0) }}</div>
                                    <div class="small text-muted">Paid</div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="p-2 rounded bg-light">
                                    <div class="text-warning font-weight-bold">₹{{ number_format(isset($financialSummary['concession_amount']) ? $financialSummary['concession_amount'] : 0, 0) }}</div>
                                    <div class="small text-muted">Concession</div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="p-2 rounded bg-light">
                                    <div class="text-{{ isset($financialSummary['remaining_amount']) && $financialSummary['remaining_amount'] > 0 ? 'danger' : 'success' }} font-weight-bold">₹{{ number_format(isset($financialSummary['remaining_amount']) ? $financialSummary['remaining_amount'] : 0, 0) }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Father Number:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $student->village ?? 'Not provided' }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-bold">Source:</td>
                                            <td>
                                                @if($student->source ?? null)
                                                    <span class="badge badge-primary">{{ ucfirst($student->source) }}</span>
                                                @else
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Referral Name:</td>
                                            <td>
                                                @if($student->referral_name ?? null)
                                                    <span class="text-success">
                                                        <i class="fas fa-user-friends mr-1"></i>{{ $student->referral_name }}
                                                    </span>
                                                @else
                                                    <span class="text-muted">Not provided</span>
                                                @endif
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $student->admission_date ? \Carbon\Carbon::parse($student->admission_date)->format('d M, Y') : 'Not recorded' }}</td>
                                        </tr>
                                        <tr>
...
<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addFeeComponentModal">
                                    ...
                                    <div class="fee-component-header">
                                        <div class="row align-items-center">
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">{{ optional($studentFee->feeCategory)->description ?? 'Standard fee component' }}</small>
                                            </div>
                                            <div class="col-md-3 text-center">
                                                <div class="h5 font-weight-bold text-primary">₹{{ number_format($totalAmount, 0) }}</div>
                                            ...
                                            <div class="col-md-3 text-center">
                                                ...
                                                @if($concessionAmount > 0)
                                                    <br><small class="text-success mt-1">
                                                        <i class="fas fa-percent"></i> ₹{{ number_format($concessionAmount, 0) }} concession
                                                    </small>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        ...
                                                        <span class="font-weight-bold text-success">₹{{ number_format($paidAmount, 0) }}</span>
                                                    </div>
                                                    <div class="col-4">
                                                        <small class="text-muted d-block">Concession</small>
                                                        <span class="font-weight-bold text-info">₹{{ number_format($concessionAmount, 0) }}</span>
                                                    </div>
                                                    <div class="col-4">
                                                        <small class="text-muted d-block">Due</small>
                                                        <span class="font-weight-bold text-danger">₹{{ number_format(max(0, $remainingAmount), 0) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-right">
                                                @if($remainingAmount > 0)
                                                    <button class="btn btn-success btn-sm mb-2" 
                                                        ...
                                                        <i class="fas fa-credit-card mr-1"></i> Pay ₹{{ number_format($remainingAmount, 0) }}
                                                    </button>
                                                    <br>
                                    ...
                                    <tbody>
                                        @foreach($paymentHistory as $payment)
                                            <tr data-payment-id="{{ $payment->id }}">
                                                <td>
                                                    <strong class="text-primary">{{ $payment->receipt_number ?? 'N/A' }}</strong>
                                                    @if($payment->transaction_id ?? null)
                                                        <small class="text-muted d-block">TXN: {{ $payment->transaction_id }}</small>
                                                    @endif
                                                </td>
                                                <td>
                                                    <span class="font-weight-bold">{{ $payment->payment_date ? $payment->payment_date->format('d M Y') : 'N/A' }}</span>
                                                    <small class="text-muted d-block">{{ $payment->created_at ? $payment->created_at->format('H:i A') : '' }}</small>
                                                </td>
                                                <td>
                                                    <span class="badge badge-success badge-lg" style="font-size: 0.9em; padding: 0.5em 0.8em;">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 text-center">
                                                    ...
                                                    <h4 class="text-success">₹{{ number_format($paymentHistory->sum('amount'), 2) }}</h4>
                                                </div>
                                                <div class="col-md-3 text-center">
                                                ...
                                                <div class="col-md-3 text-center">
                                                    ...
                                                    <div class="method-badges">
                                                        @foreach($paymentHistory->pluck('payment_method')->unique() as $method)
                                                            <span class="badge badge-secondary" style="margin: 2px; font-size: 0.7em;">{{ ucfirst($method ?? 'Unknown') }}</span>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body bg-light rounded">
                                            ...
                                            <div class="btn-group flex-wrap" role="group">
                                                ...
                                                @if(Route::has('admin.payments.component-dashboard'))
                                                    <a href="{{ route('admin.payments.component-dashboard', $student) }}" class="btn btn-outline-success btn-sm">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="form-group mb-0">
                    <select class="form-control" id="attendanceMonth" onchange="loadAttendanceData()">
                        @for($i = 0; $i < 12; $i++)
                            @php
...
{{-- Summary Cards --}}
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="totalWorkingDays">
                                            0
                                        </div>
                                        <small class="text-muted" style="font-size: 0.65rem;">(Till Date)</small>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="tabAttendancePercentage">
                                            0%
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="presentDays">
                                            0
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="absentDays">
                                            0
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="lateDays">
                                            0
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-3 px-2">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="holidayDays">
                                            0
                                        </div>
                                    </div>
                                    <div class="col-auto">
            ...
            <div id="attendanceError" style="display: none;">
                <div class="alert alert-danger">
                    ...
                    <button class="btn btn-sm btn-outline-danger mt-2" onclick="loadAttendanceData()">
                    ...
                    <div class="timeline-content">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div class="timeline-header">
                                ...
                                <p class="text-muted mb-1">{{ $activity['description'] ?? 'No description available' }}</p>
                            </div>
                            <div class="timeline-meta text-right">
                                <small class="text-muted d-block">{{ $activity['timestamp']->format('M d, Y') }}</small>
                        ...
                        @if(!empty($activity['properties'] ?? []))
                            <div class="timeline-details">
                                <button class="btn btn-sm btn-outline-secondary toggle-details" type="button" data-toggle="collapse" data-target="#details-{{ $loop->index }}">
                                ...
                                <div class="collapse mt-2" id="details-{{ $loop->index }}">
                                    <div class="card card-body bg-light">
                                        @if(($activity['type'] ?? '') === 'payment')
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <small><strong>Amount:</strong> ₹{{ number_format($activity['properties']['amount'] ?? 0, 2) }}</small><br>
                                                    <small><strong>Method:</strong> {{ ucfirst($activity['properties']['method'] ?? 'Unknown') }}</small>
                                                </div>
                                                <div class="col-md-6">
                                                    <small><strong>Receipt:</strong> {{ $activity['properties']['receipt'] ?? 'N/A' }}</small><br>
                                                    <small><strong>Components:</strong> {{ $activity['properties']['components'] ?? 0 }} items</small>
                                                </div>
                                            </div>
                                        @elseif(($activity['type'] ?? '') === 'concession')
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <small><strong>Amount:</strong> ₹{{ number_format($activity['properties']['amount'] ?? 0, 2) }}</small><br>
                                                    <small><strong>Status:</strong> {{ ucfirst($activity['properties']['status'] ?? 'Unknown') }}</small>
                                                </div>
                                                <div class="col-md-6">
                                                    @if(!empty($activity['properties']['reason'] ?? null))
                                                        <small><strong>Reason:</strong> {{ $activity['properties']['reason'] }}</small>
                                                    @endif
                                                </div>
                                            </div>
                                        @else
    ...
    <div class="col-lg-4">
        ...
        <div class="card modern-card mb-4">
            ...
            <div class="card-body text-center">
                <div class="mb-3">
                    <div class="h4 font-weight-bold text-gray-800 amount-counter">₹{{ number_format(isset($financialSummary['total_amount']) ? $financialSummary['total_amount'] : 0, 0) }}</div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="p-2 rounded bg-light">
                            <div class="text-danger font-weight-bold">₹{{ number_format(isset($financialSummary['remaining_amount']) ? $financialSummary['remaining_amount'] : 0, 0) }}</div>
                            <div class="small text-muted">Due</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card modern-card">
            ...
            <div class="card-body p-2">
                ...
                <div class="quick-action-card" onclick="window.location.href='{{ route('admin.students.edit', $student) }}'">
                    <div class="d-flex align-items-center">
                ...
                @if(Route::has('admin.payments.component-dashboard'))
                <div class="quick-action-card" onclick="window.location.href='{{ route('admin.payments.component-dashboard', $student) }}'">
                    <div class="d-flex align-items-center">
...
{{-- Enhanced Apply Concession Modal --}}
                ...
                <form id="concessionForm" action="{{ url('admin/students/' . $student->id . '/apply-concession') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="student_fee_id" id="concessionComponentSelect" class="form-control" required style="border-radius: 10px;">
                            ...
                            @if($studentFees->whereIn('status', ['unpaid', 'partial'])->count() > 0)
                                @foreach($studentFees->whereIn('status', ['unpaid', 'partial']) as $fee)
                                    @php 
                                        $remaining = ($fee->amount ?? 0) - ($fee->paid_amount ?? 0) - ($fee->concession_amount ?? 0); 
                                    @endphp
                                    @if($remaining > 0)
                                        <option value="{{ $fee->id }}" data-remaining="{{ $remaining }}">
                                            {{ optional($fee->feeCategory)->name ?? 'Unknown Category' }} 
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    ...
                    <small class="text-light opacity-75">{{ $student->enrollment_number }} • {{ optional($student->batch)->name ?? 'N/A' }}</small>
                </div>
                    ...
                    <div class="payment-form-section">
                        ...
                        <div id="fee-components-list">
                            @if($studentFees->count() > 0)
                                @foreach($studentFees as $studentFee)
                                    @php
                                        $dueAmount = ($studentFee->amount ?? 0) - ($studentFee->paid_amount ?? 0) - ($studentFee->concession_amount ?? 0);
                                    @endphp
                                    @if($dueAmount > 0)
                                        <div class="payment-component-item" data-fee-id="{{ $studentFee->id }}" data-max-amount="{{ $dueAmount }}">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="font-weight-bold">{{ optional($studentFee->feeCategory)->name ?? 'Unknown Category' }}</div>
                                                    <small class="text-muted">{{ optional($studentFee->feeCategory)->description ?? 'Standard fee component' }}</small>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="font-weight-bold text-primary">₹{{ number_format($studentFee->amount ?? 0, 0) }}</div>
