...
<style>
    ...
    .status-badge.pending { background-color: #f6c23e; }
    .status-badge.approved { background-color: #1cc88a; }
    .status-badge.rejected { background-color: #e74a3b; }
</style>
@endpush
                ...
                <tbody>
                    @forelse ($admissions as $admission)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.admissions.show', $admission) }}" class="btn btn-info btn-sm" title="View Details"><i class="fas fa-eye"></i></a>
                    ...
                    @empty
                        <tr><td colspan="6" class="text-center">No admission applications found matching your criteria.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="formLink" class="form-control" value="{{ route('enquiry.public.create') }}" readonly>
                ...
                <div class="form-group">
                    ...
                    <p class="small text-muted">Copy and paste this HTML code to show the form directly on another webpage.</p>
                    <textarea id="embedCode" class="form-control" rows="4" readonly><iframe src="{{ route('enquiry.public.create') }}" style="width:100%; height:800px; border:none;" title="Admission Form"></iframe></textarea>
                    <button class="btn btn-outline-secondary btn-sm mt-2" type="button" id="copyEmbedBtn">Copy Embed Code</button>
                </div>
            </div>
        </div>
    </div>
