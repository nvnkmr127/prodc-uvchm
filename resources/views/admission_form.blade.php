            ...
            <div class="col-lg-8">
                <div class="form-container">
                    ...
                    <div class="p-4">
                        ...
                        @if($errors->any())
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <h6><i class="fas fa-exclamation-triangle me-2"></i>Please correct the following errors:
                                </h6>
                                <ul class="mb-0">
                        ...
                        <form action="{{ route('enquiry.public.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    <label for="student_name" class="form-label">Full Name <span
                            ...
                            <div class="mb-3">
                                <label for="address" class="form-label">Village / Full Address <span
                                        class="text-danger">*</span></label>
