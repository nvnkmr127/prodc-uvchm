    ...
    <div class="container-fluid my-4">
        ...
        <div class="receipt-container">
            ...
            <div class="receipt-header">
                <h1 style="margin: 0 0 10px 0; font-size: 2rem;">{{ setting('college_name', 'Your Institution Name') }}
                </h1>
            ...
            <div class="receipt-body">
                ...
                <div class="info-section">
                    <h4
                        style="margin-bottom: 15px; color: #333; border-bottom: 2px solid #007bff; padding-bottom: 5px;">
                        👤 Student Information
                    </h4>
                    <div class="info-row">
                        ...
                        <table>
                            ...
                            <tbody>
                                @foreach($payment->componentItems as $item)
                                    <tr>
                                        <td>
                                            <strong>{{ $item->studentFee->feeCategory->name ?? 'Unknown Category' }}</strong>
                                        </td>
                                        <td class="text-right">
